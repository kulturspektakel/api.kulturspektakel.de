...
export const CardTransaction = {
  encode(
    ...
    if (message.balanceBefore !== 0) {
      writer.uint32(48).sint32(message.balanceBefore);
    }
    if (message.balanceAfter !== 0) {
      writer.uint32(56).sint32(message.balanceAfter);
    }
    if (message.depositBefore !== 0) {
      writer.uint32(64).sint32(message.depositBefore);
    }
    if (message.depositAfter !== 0) {
      writer.uint32(72).sint32(message.depositAfter);
    }
    if (message.cardId !== '') {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.balanceBefore = reader.sint32();
          break;
        case 7:
          message.balanceAfter = reader.sint32();
          break;
        case 8:
          message.depositBefore = reader.sint32();
          break;
        case 9:
          message.depositAfter = reader.sint32();
          break;
        case 10:
