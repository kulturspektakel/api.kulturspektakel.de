...
export const LogMessage_Order: MessageFns<LogMessage_Order> = {
  ...
  fromJSON(object: any): LogMessage_Order {
    return {
      ...
      crewCardId: isSet(object.crewCardId) ? bytesFromBase64(object.crewCardId) : undefined,
    };
  },
...
function createBaseLogMessage_CrewCardEnrollment(): LogMessage_CrewCardEnrollment {
  return { crewCardId: new Uint8Array(0), validFrom: 0, validForDays: 0 };
}
...
export const LogMessage_CrewCardEnrollment: MessageFns<LogMessage_CrewCardEnrollment> = {
  encode(message: LogMessage_CrewCardEnrollment, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.validFrom !== 0) {
      writer.uint32(16).int32(message.validFrom);
    }
    if (message.validForDays !== 0) {
      writer.uint32(24).int32(message.validForDays);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.validFrom = reader.int32();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.validForDays = reader.int32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): LogMessage_CrewCardEnrollment {
    return {
      crewCardId: isSet(object.crewCardId) ? bytesFromBase64(object.crewCardId) : new Uint8Array(0),
      validFrom: isSet(object.validFrom) ? globalThis.Number(object.validFrom) : 0,
      validForDays: isSet(object.validForDays) ? globalThis.Number(object.validForDays) : 0,
    };
  },
  ...
  toJSON(message: LogMessage_CrewCardEnrollment): unknown {
    ...
    if (message.validForDays !== 0) {
      obj.validForDays = Math.round(message.validForDays);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<LogMessage_CrewCardEnrollment>, I>>(
    ...
    message.validForDays = object.validForDays ?? 0;
    return message;
  },
};
