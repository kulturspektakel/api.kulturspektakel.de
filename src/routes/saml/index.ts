      ...
      <html>
        ...
        <body>
          <main>
            ...
            <a href="https://crew.kulturspektakel.de/admin/redirect?url=${encodeURIComponent(
            ...
            <hr />
            Falls du keinen Slack-Account hast, frage jemanden aus der Crew nach dem Passwort für das Wiki.
            <form method="post">
