...
<body class=" page_bodyClass or-or- -bg-gray-100- ">
  ...
  <div role="article" aria-roledescription="email" aria-label="{{{ page.title || '' }}}" lang="{{ page.language || 'de' }}">
    ...
    <h1 class="text-2xl sm-leading-32 text-black font-semibold m-0 mb-24">Absage „$bandname“</h1>
    <p>
        Hey,
    </p>
    <p>
    ...
    <p>
        Das Line-Up für unser diesjähriges Festival findet ihr unter: <a href="https://kulturspektakel.de/lineup/$eventYear" class="text-brand underline hover-no-underline">https://kulturspektakel.de/lineup/$eventYear</a>
