            ...
            <tr>
              <td align="center" class="sm-px-0">
                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="none">
                  <tr>
                    <td class="sm-p-6" style="border-radius: 4px; background-color: #fff; padding: 32px; text-align: left; font-size: 16px; line-height: 24px; color: #1f2937">    <h1 style="margin: 0; font-weight: 600">Bewerbung für das Kulturspektakel ${eventYear}</h1>
